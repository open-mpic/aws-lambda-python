...
class TestDeployedMpicApi:
    ...
    def api_should_return_200_and_passed_corroboration_given_successful_caa_check(self, api_client):
        ...
        assert (
            len(
                list(
                    filter(
                        lambda perspective: perspective.check_type == CheckType.CAA,
                        perspectives_list,
                    )
                )
            )
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                'Tests handling of 0 issue "caatestsuite.com"',
                False,
            ),
            (
            ...
            (
                "deny.basic.caatestsuite.com",
                "Tests handling of issue property for a wildcard domain",
                True,
            ),
            (
                "deny-wild.basic.caatestsuite.com",
                "Tests handling of issuewild for a wildcard domain",
                True,
            ),
            (
            ...
            (
                ...
                "Tests handling of record at IPv6-only authoritative name server",
                False,
            ),
            ...
            (
                ...
                "Tests rejection when issue property has HTML and JS",
                False,
            ),
        ],
    )
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                "permit.basic.caatestsuite.com",
                "Tests acceptance when name contains a permissible CAA record set",
                False,
            ),
            (
                "deny.permit.basic.caatestsuite.com",
                "Tests acceptance on a CAA record set",
                False,
            ),
        ],
    )
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                ...
                "Tests handling of a DNAME when CAA record exists at DNAME target",
            ),
            (
                "cname-deny-sub.basic.caatestsuite.com",
                "Tests handling of a CNAME when CAA record exists at parent of CNAME target",
            ),
        ],
    )
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                "dns-01-multi.integration-testing.open-mpic.org",
                "Proper dns-01 test with multiple TXT records",
            ),
            (
                "dns-01-cname.integration-testing.open-mpic.org",
                "Proper dns-01 test with CNAME",
            ),
        ],
    )
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                "dns-01-leading-whitespace.integration-testing.open-mpic.org",
                "leading whitespace",
            ),
            (
                "dns-01-trailing-whitespace.integration-testing.open-mpic.org",
                "trailing",
            ),
    ...
    @pytest.mark.parametrize(
        "domain_or_ip_target, purpose_of_test, token, key_authorization",
        [
            (
                "integration-testing.open-mpic.org",
                "Standard http-01 test",
                "evaGxfADs6pSRb2LAv9IZf17Dt3juxGJ-PCt92wr-oA",
                "evaGxfADs6pSRb2LAv9IZf17Dt3juxGJ-PCt92wr-oA.NzbLsXh8uDCcd-6MNwXF4W_7noWXFZAfHkxZsRGC9Xs",
            ),
            (
                "integration-testing.open-mpic.org",
                "Redirect 302 http-01 test",
                "evaGxfADs6pSRb2LAv9IZf17Dt3juxGJ-PCt92wr-oB",
                "evaGxfADs6pSRb2LAv9IZf17Dt3juxGJ-PCt92wr-oA.NzbLsXh8uDCcd-6MNwXF4W_7noWXFZAfHkxZsRGC9Xs",
            ),
        ],
    )
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                ...
                "Failed http-01 test",
                "evaGxfADs6pSRb2LAv9IZf17Dt3juxGJ-PCt92wr-oA",
                "evaGxfADs6pSRb2LAv9IZf17Dt3juxGJ-PCt92wr-oA.NzbLsXh8uDCcd-6MNwXF4W_7noWXFZAfHkxZsRGC9Xa",
            ),
            (
                "integration-testing.open-mpic.org",
                "Failed 302 http-01 test",
                "evaGxfADs6pSRb2LAv9IZf17Dt3juxGJ-PCt92wr-oB",
                "evaGxfADs6pSRb2LAv9IZf17Dt3juxGJ-PCt92wr-oA.NzbLsXh8uDCcd-6MNwXF4W_7noWXFZAfHkxZsRGC9Xa",
            ),
        ],
    ...
    @pytest.mark.parametrize(
        "domain_or_ip_target, purpose_of_test, http_token_path, challenge_value",
        [
            (
                "integration-testing.open-mpic.org",
                "Valid website change v2 challenge",
                "validation-doc.txt",
                "test-validation",
            ),
            (
                "integration-testing.open-mpic.org",
                "Valid 302 website change v2 challenge",
                "validation-doc-redirect.txt",
                "test-validation-redirect",
            ),
        ],
    )
    ...
    @pytest.mark.parametrize(
        "domain_or_ip_target, dns_record_type, challenge_value, purpose_of_test",
        [
            (
                "dns-change-txt.integration-testing.open-mpic.org",
                DnsRecordType.TXT,
                "1234567890abcdefg.",
                "standard TXT dns change",
            ),
            (
                "dns-change-cname.integration-testing.open-mpic.org",
                DnsRecordType.CNAME,
                "1234567890abcdefg.",
                "standard CNAME dns change",
            ),
            (
                "dns-change-caa.integration-testing.open-mpic.org",
                DnsRecordType.CAA,
                '0 dnschange "1234567890abcdefg."',
                "standard CAA dns change",
            ),
        ],
    )
