...
class TestMpicResponseBuilder:
    ...
    def build_response__should_include_validation_details_and_method_when_present_in_request_body(self):
        ...
        response_body = json.loads(response['body'])
        assert response_body['validation_details']['expected_challenge'] == request.dcv_details.validation_details.expected_challenge
        assert response_body['validation_method'] == request.dcv_details.validation_method
