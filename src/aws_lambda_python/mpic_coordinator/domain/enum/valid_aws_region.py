...
# TODO finish the logic here -- tracking what regions are too close to others so they don't end up in a cohort
class AwsRegion:
    def __init__(self, region_code: str, region_name):
        self.region_code = region_code
        self.region_name = region_name
        self.too_close_regions = []

    def is_region_too_close(self, region):
        return region in self.too_close_regions
...
class ValidAwsRegion(Enum):
    ...
    EU_WEST_2 = AwsRegion('eu-west-2', 'Europe (London)')
    EU_WEST_3 = AwsRegion('eu-west-3', 'Europe (Paris)')
    ...
    # FIXME this needs rework to actually work...
    too_close_regions = {
            AP_NORTHEAST_1: [AP_NORTHEAST_3],
            AP_NORTHEAST_3: [AP_NORTHEAST_1],
            EU_CENTRAL_1: [EU_CENTRAL_2],
            EU_CENTRAL_2: [EU_CENTRAL_1, EU_SOUTH_1],
            EU_SOUTH_1: [EU_CENTRAL_2],
            EU_WEST_2: [EU_WEST_3],
            EU_WEST_3: [EU_WEST_2],
            US_WEST_1: [US_WEST_2],
            US_WEST_2: [US_WEST_1]
